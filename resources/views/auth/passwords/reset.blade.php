                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <a href="javascript:void(0);" class="brand-logo">
                                <h2 class="brand-text text-primary ml-1">All-On-My-Web</h2>
                            </a>
                            ...
                            <form class="auth-reset-password-form mt-2" action="{{ route('reset.password.post') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control   @error('password') is-invalid @enderror" id="reset-password-new" name="password" aria-describedby="reset-password-new" tabindex="1" autofocus />
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-merge form-password-toggle">
                                        <input type="password" class="form-control form-control-merge" id="reset-password-confirm" name="password_confirmation" aria-describedby="reset-password-confirm" tabindex="2" />
                                    </div>
                                </div>
