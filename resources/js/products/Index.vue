...
<!--                        Temporary comment out spinner-->
<!--                        <div v-if="contentLoading" class="spinner-grow text-primary" id="content-loading"> &lt;!&ndash; Add your spinner HTML or CSS class here &ndash;&gt;-->
<!--                            &lt;!&ndash; Spinner HTML or CSS &ndash;&gt;-->
<!--                        </div>-->
                            ...
                            <div class="card-body">
                                <div class="item-wrapper">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <h6 v-if="product.discount>0"><del>$<span class="wishlist-price mr-1">{{ product.price }}</span></del> </h6>
